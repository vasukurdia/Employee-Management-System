  ...
  return (
    <div className='bg-[#1c1c1c] p-3 sm:p-5 rounded mt-5 overflow-x-auto'>
        ...
        {userData.map(function(elem,idx){
            ...
            <h3 className='text-sm sm:text-lg font-medium w-1/5 text-blue-400'>{elem.taskNumbers.newTask}</h3>
            <h5 className='text-sm sm:text-lg font-medium w-1/5 text-yellow-400'>{elem.taskNumbers.active}</h5>
            <h5 className='text-sm sm:text-lg font-medium w-1/5 text-white'>{elem.taskNumbers.completed}</h5>
            <h5 className='text-sm sm:text-lg font-medium w-1/5 text-red-600'>{elem.taskNumbers.failed}</h5>
        </div>
        })}
        </div>
    </div>
